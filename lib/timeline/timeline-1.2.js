    ...
    try {
        ...
        var a = function (f) {
            if (document.body == null) {
                try {
                    document.write("<link rel='stylesheet' href='" + f + "' type='text/css'/>");
                    return
                } catch (h) {
                }
            }
...
Timeline.createBandInfo = function (h) {
    ...
    var a = {showText: ("showEventText" in h) ? h.showEventText : true, layout: d, theme: g};
    if ("trackHeight" in h) {
...
Timeline.createHotZoneBandInfo = function (h) {
    ...
    var d = new Timeline.StaticTrackBasedLayout({eventSource: f, ether: e, theme: g});
    var a = {showText: ("showEventText" in h) ? h.showEventText : true, layout: d, theme: g};
    if ("trackHeight" in h) {
        a.trackHeight = h.trackHeight
    }
...
Timeline._Impl.prototype._initialize = function () {
    ...
    var a = Timeline.Graphics.createTranslucentImage(d, "http://static.simile.mit.edu/timeline/api/images/copyright-vertical.png");
    ...
    for (var b = 0; b < this._bandInfos.length; b++) {
        ...
        if ("syncWith" in e) {
            this._bands[b].setSyncWithBand(this._bands[e.syncWith], ("highlight" in e) ? e.highlight : false)
        }
    }
...
Timeline._Band = function (f, g, c) {
    ...
    this._bandInfo = g;
    this._index = c;
    this._locale = ("locale" in g) ? g.locale : Timeline.Platform.getDefaultLocale();
    this._timeZone = ("timeZone" in g) ? g.timeZone : 0;
    this._labeller = ("labeller" in g) ? g.labeller : f.getUnit().createLabeller(this._locale, this._timeZone);
...
Timeline._Band.prototype.openBubbleForPoint = function (d, b, c, a) {
    this.closeBubble();
    this._bubble = Timeline.Graphics.createBubbleForPoint(this._timeline.getDocument(), d, b, c, a);
...
Timeline._Band.prototype.scrollToCenter = function (b) {
    ...
    this._autoScroll(Math.round(this._viewLength / 2 - this._ether.dateToPixelOffset(b)))
};
...
(function () {
    ...
    Timeline.Platform.os.isWin32 = Timeline.Platform.isWin && (a.indexOf("95") != -1 || a.indexOf("98") != -1 || a.indexOf("nt") != -1 || a.indexOf("win32") != -1 || a.indexOf("32bit") != -1);
...
Timeline.DateTime.roundDownToInterval = function (b, h, k, l, a) {
    ...
    switch (h) {
        ...
        case Timeline.DateTime.MINUTE:
            ...
            j.setTime(j.getTime() - (i % l) * Timeline.DateTime.gregorianUnitLengths[Timeline.DateTime.MINUTE]);
            break;
        ...
        case Timeline.DateTime.WEEK:
            ...
            j.setTime(j.getTime() - g * Timeline.DateTime.gregorianUnitLengths[Timeline.DateTime.DAY]);
            break;
...
Timeline.DateTime.incrementByInterval = function (a, b) {
    switch (b) {
        ...
        case Timeline.DateTime.SECOND:
            ...
            break;
        case Timeline.DateTime.MINUTE:
            a.setTime(a.getTime() + Timeline.DateTime.gregorianUnitLengths[Timeline.DateTime.MINUTE]);
            break;
        case Timeline.DateTime.HOUR:
            a.setTime(a.getTime() + Timeline.DateTime.gregorianUnitLengths[Timeline.DateTime.HOUR]);
            break;
        case Timeline.DateTime.DAY:
...
Timeline.DateTime.removeTimeZoneOffset = function (b, a) {
    return new Date(b.getTime() + a * Timeline.DateTime.gregorianUnitLengths[Timeline.DateTime.HOUR])
};
...
Timeline.Graphics.createBubbleForPoint = function (u, c, b, l, p) {
    ...
    var k = {
        _closed: false, _doc: u, close: function () {
            if (!this._closed) {
    ...
    var a = function (x, w, y, v) {
        ...
        if (o) {
            ...
            x.style.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + w + "', sizingMethod='crop')"
        }
    };
    ...
    q(i + "images/bubble-bottom-right.png", d.left + l, d.top + p, d.right, d.bottom);
    var t = u.createElement("div");
    t.style.left = (n - d.right + Timeline.Graphics._bubblePadding - 16 - 2) + "px";
    ...
    k.content = e;
    (function () {
        if (c - Timeline.Graphics._halfArrowWidth - Timeline.Graphics._bubblePadding > 0 && c + Timeline.Graphics._halfArrowWidth + Timeline.Graphics._bubblePadding < g) {
            var x = c - Math.round(l / 2) - d.left;
            x = c < (g / 2) ? Math.max(x, -(d.left - Timeline.Graphics._bubblePadding)) : Math.min(x, g + (d.right - Timeline.Graphics._bubblePadding) - n);
            if (b - Timeline.Graphics._bubblePointOffset - s > 0) {
                var v = u.createElement("div");
                v.style.left = (c - Timeline.Graphics._halfArrowWidth - x) + "px";
                v.style.top = (d.top + p) + "px";
                a(v, i + "images/bubble-bottom-arrow.png", 37, d.bottom);
                h.appendChild(v);
                j.style.left = x + "px";
                j.style.top = (b - Timeline.Graphics._bubblePointOffset - s + Timeline.Graphics._arrowOffsets.bottom) + "px";
                return
            } else {
                if (b + Timeline.Graphics._bubblePointOffset + s < f) {
                    ...
                    h.appendChild(v);
                    j.style.left = x + "px";
                    j.style.top = (b + Timeline.Graphics._bubblePointOffset - Timeline.Graphics._arrowOffsets.top) + "px";
                    return
                }
            }
        }
        var w = b - Math.round(p / 2) - d.top;
        w = b < (f / 2) ? Math.max(w, -(d.top - Timeline.Graphics._bubblePadding)) : Math.min(w, f + (d.bottom - Timeline.Graphics._bubblePadding) - s);
        if (c - Timeline.Graphics._bubblePointOffset - n > 0) {
            ...
            h.appendChild(v);
            j.style.left = (c - Timeline.Graphics._bubblePointOffset - n + Timeline.Graphics._arrowOffsets.right) + "px";
            j.style.top = w + "px"
        } else {
            var v = u.createElement("div");
            v.style.left = "0px";
            ...
            h.appendChild(v);
            j.style.left = (c + Timeline.Graphics._bubblePointOffset - Timeline.Graphics._arrowOffsets.left) + "px";
            j.style.top = w + "px"
        }
    })();
...
Timeline.Graphics.createMessageBubble = function (h) {
    ...
    if (Timeline.Graphics.pngIsTranslucent) {
        ...
        i.style.height = "33px";
        i.style.background = "url(" + Timeline.urlPrefix + "images/message-top-left.png) top left no-repeat";
        i.style.paddingLeft = "44px";
        g.appendChild(i);
        var c = h.createElement("div");
        c.style.height = "33px";
        c.style.background = "url(" + Timeline.urlPrefix + "images/message-top-right.png) top right no-repeat";
        i.appendChild(c);
        var f = h.createElement("div");
        f.style.background = "url(" + Timeline.urlPrefix + "images/message-left.png) top left repeat-y";
        f.style.paddingLeft = "44px";
        g.appendChild(f);
        var a = h.createElement("div");
        a.style.background = "url(" + Timeline.urlPrefix + "images/message-right.png) top right repeat-y";
        ...
        b.style.height = "55px";
        b.style.background = "url(" + Timeline.urlPrefix + "images/message-bottom-left.png) bottom left no-repeat";
        b.style.paddingLeft = "44px";
        g.appendChild(b);
        var e = h.createElement("div");
        e.style.height = "55px";
        e.style.background = "url(" + Timeline.urlPrefix + "images/message-bottom-right.png) bottom right no-repeat";
        b.appendChild(e)
    } else {
...
Timeline.SpanHighlightDecorator.prototype.paint = function () {
    ...
    if (this._unit.compare(this._startDate, c) < 0 && this._unit.compare(this._endDate, e) > 0) {
...
Timeline.GregorianEtherPainter.prototype.paint = function () {
    ...
    Timeline.DateTime.roundDownToInterval(c, this._unit, b, this._multiple, this._theme.firstDayOfWeek);
    var d = this;
    var a = function (g) {
...
Timeline.HotZoneGregorianEtherPainter.prototype.paint = function () {
    ...
    for (var h = c; h <= e; h++) {
        ...
        Timeline.DateTime.roundDownToInterval(j, g.unit, k, g.multiple, this._theme.firstDayOfWeek);
        Timeline.DateTime.roundUpToInterval(f, g.unit, k, g.multiple, this._theme.firstDayOfWeek);
...
Timeline.YearCountEtherPainter.prototype.paint = function () {
    ...
    while (b.getTime() < f.getTime()) {
        this._intervalMarkerLayout.createIntervalMarker(b, d, Timeline.DateTime.YEAR, this._markerLayer, this._lineLayer);
        a(b)
    }
    this._markerLayer.style.display = "block";
    this._lineLayer.style.display = "block"
        ...
        for (var c = 0; c < this._zones.length && this._unit.compare(f, d) > 0; c++) {
            ...
            if (this._unit.compare(d, a.endTime) < 0) {
                if (this._unit.compare(d, a.startTime) > 0) {
                    this._zones.splice(c, 0, {startTime: a.startTime, endTime: d, magnify: a.magnify});
                    c++;
                    a.startTime = d
                }
                if (this._unit.compare(f, a.endTime) < 0) {
                    this._zones.splice(c, 0, {startTime: d, endTime: f, magnify: b.magnify * a.magnify});
                    c++;
                    a.startTime = f;
                    d = f
                } else {
...
Timeline.GregorianDateLabeller.prototype.labelPrecise = function (a) {
    return Timeline.DateTime.removeTimeZoneOffset(a, this._timeZone).toUTCString()
};
Timeline.GregorianDateLabeller.prototype.defaultLabelInterval = function (b, f) {
    ...
    switch (f) {
        ...
        case Timeline.DateTime.MILLENNIUM:
            ...
            e = (f == Timeline.DateTime.MONTH) || (f == Timeline.DateTime.DECADE && d % 100 == 0) || (f == Timeline.DateTime.CENTURY && d % 1000 == 0);
            break;
        default:
            c = b.toUTCString()
    }
...
Timeline.DurationEventPainter = function (a) {
    ...
    this._showLineForNoText = ("showLineForNoText" in a) ? a.showLineForNoText : a.theme.event.instant.showLineForNoText;
...
Timeline.DurationEventPainter.prototype.paint = function () {
    ...
    var b = ("trackHeight" in this._params) ? this._params.trackHeight : o.track.height;
    var s = ("trackGap" in this._params) ? this._params.trackGap : o.track.gap;
    var c = function (p, z) {
        var y = p.getIcon();
        var x = Timeline.Graphics.createTranslucentImage(w, y != null ? y : o.instant.icon);
        z.appendChild(x);
    ...
    var l = function (I, E, p, C, B, H, G) {
        ...
        if (a) {
            ...
            if (k._showLineForNoText) {
                y.style.width = "1px";
                y.style.borderLeft = "1px solid " + (x != null ? x : o.instant.lineColor);
                D = 0;
                A = 1
            } else {
                c(I, y)
    ...
    var g = function (F, z, p, C, G, K, y) {
        ...
        if (a) {
            ...
            H.style.color = x != null ? x : (N ? o.label.outsideColor : o.label.insideColor);
            H.style.overflow = "hidden";
    ...
    var i = (this._highlightMatcher != null) ? this._highlightMatcher : function (p) {
        return -1
    };
...
Timeline.DurationEventPainter.prototype._onClickInstantEvent = function (b, d, a) {
    ...
    this._showBubble(e.left + Math.ceil(b.offsetWidth / 2), e.top + Math.ceil(b.offsetHeight / 2), a)
};
Timeline.DurationEventPainter.prototype._onClickDurationEvent = function (d, b, e) {
    d.cancelBubble = true;
    if ("pageX" in d) {
        var a = d.pageX;
        var g = d.pageY
...
Timeline.DurationEventPainter.prototype._showBubble = function (a, d, b) {
    var c = this._band.openBubbleForPoint(a, d, this._theme.event.bubble.width, this._theme.event.bubble.height);
...
Timeline.DefaultEventSource.prototype.loadJSON = function (f, b) {
    ...
    if (f && f.events) {
        ...
        for (var e = 0; e < f.events.length; e++) {
            var a = f.events[e];
            var k = new Timeline.DefaultEventSource.Event(g(a.start), g(a.end), g(a.latestStart), g(a.earliestEnd), a.isDuration || false, a.title, a.description, this._resolveRelativeURL(a.image, c), this._resolveRelativeURL(a.link, c), this._resolveRelativeURL(a.icon, c), a.color, a.textColor);
            k._obj = a;
...
Timeline.DefaultEventSource.Event.prototype = {
    getID: function () {
        ...
        if (this._wikiURL != null && this._wikiSection != null) {
            ...
            d = d.replace(/\s/g, "_");
            var c = this._wikiURL + this._wikiSection.replace(/\s/g, "_") + "/" + d;
...
Timeline.ClassicTheme._Impl = function () {
    ...
    this.ether = {
        ...
        highlightOpacity: 50,
        interval: {
            line: {show: true, color: "#aaa", opacity: 25},
            weekend: {color: "#FFFFE0", opacity: 30},
            marker: {
                hAlign: "Bottom", hBottomStyler: function (a) {
                ...
                }, vAlign: "Right", vRightStyler: function (a) {
    ...
    this.event = {
        track: {offset: 0.5, height: 1.5, gap: 0.5},
        instant: {
        ...
        duration: {color: "#58A0DC", opacity: 100, impreciseColor: "#58A0DC", impreciseOpacity: 20},
        label: {insideColor: "white", outsideColor: "black", width: 200},
        highlightColors: ["#FFFF00", "#FFC000", "#FF0000", "#0000FF"],
        bubble: {
            width: 250, height: 125, titleStyler: function (a) {
